    ...
    var e = /\blang(?:uage)?-(\w+)\b/i,
      t = (_self.Prism = {
        ...
        highlightElement: function(n, a, r) {
          ...
          o &&
            (
              (l = (o.className.match(e) || [, ''])[1]),
              (i = t.languages[l])
            ), (n.className =
            n.className.replace(e, '').replace(/\s+/g, ' ') +
            ' language-' +
            l), (o = n.parentNode), /pre/i.test(o.nodeName) &&
            (o.className =
          ...
          if ((t.hooks.run('before-highlight', u), a && _self.Worker)) {
            ...
            (u.highlightedCode = t.highlight(
              ...
              u.highlightedCode), r && r.call(n), t.hooks.run(
              'after-highlight',
              u
            ), t.hooks.run('complete', u);
        },
                ...
                for (var p = 0; p < r.length; p++) {
                  ...
                  if (!(d instanceof a)) {
                    ...
                    if (m) {
                      ...
                      P.push(A), w && P.push(w), Array.prototype.splice.apply(
                        r,
                        P
                      );
                    }
            ...
            _self.addEventListener(
              ...
              function(e) {
                var n = JSON.parse(e.data),
                  ...
                  r = n.code,
                  l = n.immediateClose;
                _self.postMessage(t.highlight(r, t.languages[a], a)), l &&
                  _self.close();
              },
              !1
            ),
...
!(function(a) {
  ...
  (a.languages.jsx = a.languages.extend(
    'markup',
    e
  )), (a.languages.jsx.tag.pattern = /<\/?[\w\.:-]+\s*(?:\s+[\w\.:-]+(?:=(?:("|')(\\?[\w\W])*?\1|[^\s'">=]+|(\{[\w\W]*?\})))?\s*)*\/?>/i), (a.languages.jsx.tag.inside[
    'attr-value'
  ].pattern = /=[^\{](?:('|")[\w\W]*?(\1)|[^\s>]+)/i);
